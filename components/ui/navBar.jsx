"use client";
import { Contact, Search, ShoppingBag } from "lucide-react";
...
export default function NavBar() {
  return (
    <div className="lg:h-[88px] flex justify-between items-center md:h-[64px] h-[44px]  w-full bg-primary px-4 md:py-4  lg:px-[192px] ">
      <div className="flex items-center gap-2">
        ...
        <p className="font-bold text-2xl text-slate-300">LOGO</p>
      </div>
      <div className="bg-white w-1/3 h-9/10 flex  rounded-full  ">
        <div className="flex items-center ml-2">
          <Search className=" border-r-2 "></Search>
        </div>
        <Input className="border-none rounded-full"></Input>
      </div>
